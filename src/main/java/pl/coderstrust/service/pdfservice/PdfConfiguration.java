...
public class PdfConfiguration {
  ...
  public static final Stream<String> COMPANIES_TABLE_HEADERS = Stream.of("Property", "Seller", "Buyer");
  public static final Stream<String> PRODUCTS_TABLE_HEADERS = Stream.of("Name", "Description", "Type", "Amount", "Net Value", "Vat Rate");
